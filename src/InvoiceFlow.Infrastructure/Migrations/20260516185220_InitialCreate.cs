        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSentChannel = table.Column<int>(type: "integer", nullable: true),
                    StripePaymentLink = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_TenantId_IsActive",
                table: "Clients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentReminders_Status_ScheduledAt",
                table: "PaymentReminders",
